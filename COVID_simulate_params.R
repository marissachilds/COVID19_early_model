...
# iso_start          <- 500     ## when isolation of infected individuals starts 
red_shelt.t        <- 500     ## Time shelter in place changes to a reduced form (inf_iso or light) -- Now June 1 (day 76 of shelter in place orders) in days
red_shelt.s        <- 0.5     ## New social dist strength after time red_shelt.t
light              <- FALSE   ## Lightswitch method
# light_start        <- 500     # when lightswitch goes into effect. lightswitch overrides background social distancing and alternates between the fit SIP value and the red_shelter.s value
